...
- **custom_stoploss**: **진입 경로별 분리** — 모멘텀(fusion/ta_breakout): ATR×1.2 초기 + 4단계 trailing (+1.5% ATR×0.4, +0.8% ATR×0.5, +0.5% ATR×0.6, ATR활성 ATR×0.7), breakeven +0.5%. **rsi_bounce**: ATR×**2.0** 초기, breakeven +1.0%
- **ROI**: {"0": 1.5%, "5": 1%, "10": 0.7%, "15": 0.5%, "30": 0.4%, "60": 0.3%}, **SL**: -1.5%
