...
- **fusion_strong**: fusion_prob ≥ 0.62 + do_predict=1 (고확신)
- **fusion_buy**: fusion_prob ≥ 0.50 + do_predict=1 (표준)
- **ta_breakout**: ta_score > 40 + breakout_signal=1 + close > SMA200 + RSI < 70 (fusion 독립, TA 기반)
- **rsi_bounce**: RSI < 25 + ta_score > 10 + close > SMA200×0.97 (평균회귀 스캘프)
