...
- **fusion_buy**: fusion_prob ≥ **0.45** + do_predict=1 + vol > 20MA (표준, 2026-05-28 cold-start 가속용 0.50→0.45)
...
- **Stage 2 필터**: fusion_strong/ta_breakout에 전체 SEPA (close > SMA50 > SMA150 > SMA200) 적용. **fusion_buy**는 `close > SMA50`만 (횡보장 대응 완화). rsi_bounce(평균회귀)는 면제
